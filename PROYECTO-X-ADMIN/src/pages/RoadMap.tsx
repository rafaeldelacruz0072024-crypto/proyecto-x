      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Plan de evolución del protocolo GEMINIX</p>
          </div>
        </div>
                ...
                <div className="flex items-center justify-center">
                  <div className="relative">
                    ...
                    <div className="relative w-36 h-36 rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 border-2 border-blue-400/50 flex flex-col items-center justify-center shadow-2xl shadow-blue-500/30">
                      ...
                      <span className="text-white font-black text-xs uppercase tracking-widest leading-tight text-center">GEMINIX<br/>PROTOCOL</span>
                    </div>
                  </div>
                </div>
