...
OUT = os.path.join(os.path.dirname(__file__), "GEMINIX_Plan_Compensacion.pdf")
...
c.setTitle("GEMINIX | Plan de Compensación")
...
c.drawCentredString(W/2, FT_Y - 36, "geminixprotocol.com  ·  Los porcentajes son referenciales y pueden variar según los parámetros del sistema  ·  © 2025 GEMINIX")
