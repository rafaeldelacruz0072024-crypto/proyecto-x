-- ============================================================
-- GEMINIX CARD: Fee 0% en retiros con método GEMINIX CARD
-- Actualiza create_withdrawal_request para eximir de comisión
-- a los retiros procesados vía tarjeta corporativa Geminix.
-- ============================================================
...
BEGIN
  ...
  -- 10. Calcular fee — GEMINIX CARD tiene 0% durante 30 días (hasta 2026-05-22)
  IF p_method = 'GEMINIX CARD' AND NOW() <= TIMESTAMPTZ '2026-05-22 23:59:59-04:00' THEN
    v_fee_amount := 0;
  ...
  RETURN jsonb_build_object(
    ...
    'card_withdrawal', (p_method = 'GEMINIX CARD')
  );
END;
$$;
