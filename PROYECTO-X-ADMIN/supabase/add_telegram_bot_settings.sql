...
SET 
  telegram_welcome_en = COALESCE(telegram_welcome_en, 'Welcome to NOVA DIGITAL! Follow our channel and bot to earn rewards.'),
  telegram_welcome_es = COALESCE(telegram_welcome_es, '¡Bienvenido a NOVA DIGITAL! Sigue nuestro canal y bot para ganar recompensas.'),
  telegram_welcome_pt = COALESCE(telegram_welcome_pt, 'Bem-vindo ao NOVA DIGITAL! Siga nosso canal e bot para ganhar recompensas.'),
  telegram_welcome_zh = COALESCE(telegram_welcome_zh, '欢迎来到 NOVA DIGITAL！关注我们的频道和机器人以获取奖励。')
